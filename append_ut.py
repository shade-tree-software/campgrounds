#!/usr/bin/env python3
"""Append Utah add-research results to campgrounds.json.

Usage: python3 append_ut.py <results.json> [results2.json ...]
...
entry but recorded to /tmp/ut_leads.json keyed by assigned id for the audit stage.
"""
import json, sys, io, html

CG = "/home/andrew/Dev/campgrounds/campgrounds.json"
LEADS = "/tmp/ut_leads.json"
