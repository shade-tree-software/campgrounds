...
surfacing any of this in the map popup, map filters, or manage-table sort — the data is
live but only the manage form shows it; the NL corridor search that started the whole
thread (deliberately tabled).
