...
description: "AUTHORITATIVE inclusion-backfill status. Waterfront 100% everywhere. Inclusion: as of 2026-07-22 end-of-session, 10 states / ~163 entries LEFT (OH 44 NEXT UP, then MD/ME/VT/NH/NJ/MA/CT/DE/RI). 9 states done this session (AR/GA/NC/MS/KS/MO/VA/WV/SC). Start here for the next inclusion session; re-scan the live JSON field first."
metadata: 
  node_type: memory
  type: project
...
- **Inclusion: remaining 10 states, ~163 entries.** NEXT UP = **OH (44)**, then MD 29, ME 23, VT 19, NH 15, NJ 10, MA 7, CT 7, DE 5, RI 4.
- **SESSION 2026-07-22 recap:** did 9 states in one sitting — AR, GA, NC, MS, KS, MO, VA, WV, SC (~1,314 entries audited, 9 removals, 3 data fixes). All committed + pushed. Removals were all owner-approved via AskUserQuestion: GA Harris Branch (day-use), NC Spruill (under-22ft)/Paul's RV (closed), VA Crabtree Falls (4WD), WV Spring Gap (20ft)/Groundhog (trailhead)/Sleepy Creek+Canaan Loop (unverified 4WD), SC Pleasant Ridge (group-only). Method held perfectly (100% id-match, no session-limit issues). Owner-dispersed-site pattern: surface for owner call, never auto-delete; owner kept+flagged the VA Long Run Road/Flagpole Knob sites but removed the clearer 4WD/day-use ones.
