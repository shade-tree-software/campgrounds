#!/usr/bin/env python3
"""Append Saskatchewan add-research results to campgrounds.json.

Usage: python3 append_sk.py <results.json> [results2.json ...]
...
entry but recorded to /tmp/sk_leads.json keyed by assigned id for the audit stage.
"""
import json, sys, io, html

CG = "/home/andrew/Dev/campgrounds/campgrounds.json"
LEADS = "/tmp/sk_leads.json"
