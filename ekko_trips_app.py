...
class _BackgroundScan:
    ...
    uploads and the place resolver behind road cards — and both need the same
    three awkward details right: coalescing an upload burst into one process,
    probing for an interpreter that actually has the dependency, and never
    letting a background failure reach the request that triggered it.
...
def trip_detail(trip_id):
    ...
    if road_photos:
        ...
        # Straggler sweep, for the same reason any out-of-band job needs one.
