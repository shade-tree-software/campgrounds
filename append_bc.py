#!/usr/bin/env python3
"""Append Ontario add-research results to campgrounds.json.

Usage: python3 append_on.py <results.json> [results2.json ...]
...
entry but recorded to /tmp/bc_leads.json keyed by assigned id for the audit stage.
"""
import json, sys, io

CG = "/home/andrew/Dev/campgrounds/campgrounds.json"
LEADS = "/tmp/bc_leads.json"
